...
public class RepositoryJobConfigurationTest {
    ...
    public void testInitialization() throws Exception {
        ...
        ConfigurationRepositories confRepos = new ConfigurationRepositories(
                mavenBaseDir + "/src/test/resources/com/soebes/supose/config/configuration-repository.ini");
        ...
        assertNotNull(reposConfig,
                "We had expected to get a configuration for the repository '" + repositoryName + "'");
