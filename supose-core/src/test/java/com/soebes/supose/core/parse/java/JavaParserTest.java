 ...
 */
package com.soebes.supose.core.parse.java;
...
public class JavaParserTest extends TestBase {
    ...
    public void testFirstJavaFile() throws Exception {
        ...
        ANTLRFileStream input = new ANTLRFileStream(
                getFileResource("Test1.java.test"));
        ...
        assertTrue(methods.size() == 5,
                "We had expected to get five different methods");
        ...
        assertTrue(lexer.getComments().size() == 4,
                "We have expected to get four different comments");
