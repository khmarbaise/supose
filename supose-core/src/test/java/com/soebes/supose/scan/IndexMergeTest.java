...
public class IndexMergeTest {
    ...
    private static void addTokenizedField(Document doc, String fieldName,
            String value) {
    ...
    public void afterClass() {
        assertTrue(deleteDirectory("index1"),
                "Something wrong during deletion of index1");
        assertTrue(deleteDirectory("index2"),
                "Something wrong during deletion of index2");
        assertTrue(deleteDirectory("result"),
                "Something wrong during deletion of result");
    }
    ...
    public void testMergeIndexes() throws Exception {
        ...
        FSDirectory fsDirs[] = { FSDirectory.getDirectory("index1"),
                FSDirectory.getDirectory("index2") };
