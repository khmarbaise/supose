 ...
 */
public class ScanODSDocument extends AScanDocument {
    private static Logger LOGGER = Logger.getLogger(ScanODSDocument.class);

    public ScanODSDocument() {
    }

    @Override
    public void indexDocument(Repository repository, SVNDirEntry dirEntry,
            String path, long revision) {
        LOGGER.debug("Scanning ODS document");
        try {
