...
public class FilterFileTest extends TestBase {
    ...
    public void readFilterTest() throws IOException, XmlPullParserException {
        ...
        assertEquals(repositories.getRepository().size(), 1);

        Repository repository = repositories.getRepository().get(0);
        assertEquals(repository.getId(), "default");

        assertEquals(repository.getFilenames().getIncludes().size(), 1);
        assertEquals(repository.getFilenames().getExcludes().size(), 0);

        assertEquals(repository.getPaths().getIncludes().size(), 1);
        assertEquals(repository.getPaths().getExcludes().size(), 0);

        assertEquals(repository.getProperties().getIncludes().size(), 1);
        assertEquals(repository.getProperties().getExcludes().size(), 0);
    }
    ...
    public void hasFilenamesTest() {
        ...
        assertEquals(repos.hasFilenames(), false);

        repos.setFilenames(il);

        assertEquals(repos.hasFilenames(), true);
    }
    ...
    public void hasPathsTest() {
        ...
        assertEquals(repos.hasPaths(), false);

        repos.setPaths(il);

        assertEquals(repos.hasPaths(), true);
    }
    ...
    public void hasPropertiesTest() {
        ...
        assertEquals(repos.hasProperties(), false);

        repos.setProperties(il);

        assertEquals(repos.hasProperties(), true);
    }
    ...
    public void hasRepositoryTest() throws FileNotFoundException, IOException, XmlPullParserException {
        ...
        assertEquals(filtering.hasRepository("default"), true);
        assertEquals(filtering.hasRepository("Default"), false);
    }
    ...
    public void hasExcludesIncludesTest() throws FileNotFoundException, IOException, XmlPullParserException {
        ...
        assertEquals(repository.getFilenames().hasExcludes(), false);
        assertEquals(repository.getFilenames().hasIncludes(), true);
