...
SET CP=%CP%;.\lib\ini4j-${ini4j.version}-jdk14.jar
...
SET CP=%CP%;.\lib\poi-3.5-beta5.jar
SET CP=%CP%;.\lib\poi-scratchpad-3.5-beta5.jar
SET CP=%CP%;.\lib\poi-ooxml-3.5-beta5.jar
...
SET CP=%CP%;.\lib\svnkit-1.2.3.5521.jar
SET CP=%CP%;.\lib\tika-${tika.version}.jar
