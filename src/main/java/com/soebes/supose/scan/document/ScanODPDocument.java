 ...
 */
public class ScanODPDocument extends AScanDocument {
	private static Logger LOGGER = Logger.getLogger(ScanODPDocument.class);

	public ScanODPDocument() {
	}

	@Override
	public void indexDocument(Repository repository, SVNDirEntry dirEntry, String path, long revision) {
		LOGGER.debug("Scanning ODP document");
		try {
