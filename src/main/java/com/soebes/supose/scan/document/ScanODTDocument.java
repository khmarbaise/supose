 ...
 */
public class ScanODTDocument extends AScanDocument {
	private static Logger LOGGER = Logger.getLogger(ScanODTDocument.class);

	public ScanODTDocument() {
	}

	@Override
	public void indexDocument(Repository repository, SVNDirEntry dirEntry, String path, long revision) {
		LOGGER.debug("Scanning ODT document");
		try {
